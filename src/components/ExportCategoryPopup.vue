<template>
  ...
  export default defineComponent({
    ...
    emits: ['cancel', 'save'],
    setup: ({ categoryId, categoryName, realizedRequirements, activeRequirements }, { emit }) => {
    ...
    if(all){
        ...
        var header ={text:t('headerExportCatActive')+" "+categoryName+":\n\n", style: 'header'};
