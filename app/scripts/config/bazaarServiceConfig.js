...
var app = angular.module('requirementsBazaarWebFrontendApp');


/*
*  The BASE_URL is the location of the backend service.
*
* */
app.constant( 'bazaarServiceConfig', {
...
*
*  The fields are standard, and I am using a component for the implementation http://andreareginato.github.io/oauth-ng/
*
* */
