 ...
 *
 * Holds the functionality that might be used regardless of the currently rendered view
 *
 * Functionality
 *   1. detect if the user is mobile
 *   2. function calls for navigation
 *   3. login / logout listeners (http://andreareginato.github.io/oauth-ng/)
 *
 */
...
angular.module('requirementsBazaarWebFrontendApp')
  .controller('IndexCtrl', function ($scope, $location, $sce, UtilityService, reqBazService, HttpErrorHandlingService) {
    ...
    /*
    * Function calls for navigation, these are used throughout the site
    *
    * */
    ...
    $scope.goToProject = function(id,componentId){
      if(componentId){
        $location.path('/project/'+id+'/component/'+componentId, true);
      }else{
