...
angular.module('requirementsBazaarWebFrontendApp').config(function ($translateProvider) {
  $translateProvider.translations('en', {
    ...
    .translations('de', {
      ...
      CONTACT: 'Kontakt',
      CREATE_BETTER_PROJECTS_WITH_US: 'Höre auf deine Benutzer!',
      EMAIL: 'reqbaz@dbis.rwth-aachen.de',
      EXPLORE_PUBLIC_PROJECTS: 'Öffentliche Projekte anschauen',
      GET_STARTED: 'Loslegen',
      GET_STARTED_DESC: 'Schau dir die Beispielprojekte an und erstelle ein eigenes',
      ...
      IMAGE_TEXT_3: 'Spare Zeit und Mühe. Fokussier dich auf die Sachen die die Nutzer wirklich interessieren.',
      LEARN_MORE: 'Schau dir das Video an um mehr zu erfahren',
      MOTIVATION_MAIN: 'Requirements Bazaar lässt Benutzer wertvolles Feedback eingeben damit du dich auf die wichtigen Sachen konzentrieren kannst.',
