...
angular.module('requirementsBazaarWebFrontendApp').config(function ($translateProvider) {
  ...
  $translateProvider.translations('en', {
    ...
    .translations('de', {
      ...
      IMAGE_TEXT_1: 'Höre auf deine Benutzer und reagiere auf ihr Feedback',
      IMAGE_TEXT_2: 'Continuous Innovation. Bring Nutzer, Entwickler und Operator in einer gemeinsamen Umgebung zusammen',
      IMAGE_TEXT_3: 'Spare Zeit und Mühe. Fokussiere dich auf die Funktionen welche die Nutzer wirklich interessieren',
      LEARN_MORE: 'Schau dir das Video an um mehr zu erfahren',
      MOTIVATION_MAIN: 'Requirements Bazaar lässt Benutzer nützliches Feedback eingeben damit du dich auf die wichtigen Funktionen konzentrieren kannst',
      STEP_1: '1. Erstelle ein neues Projekt auf Requirements Bazaar',
      STEP_2: '2. Führe Benutzer zu deinem Projekt',
      STEP_3: '3. Reagiere auf das Feedback',
      ...
      COMPONENT_LEAD: 'Komponenten Leiter:',
      CREATE: 'Erstellen',
      CREATE_PROJ: 'Erstelle Projekt',
      CREATE_COMP: 'Erstelle Komponente',
      CREATE_REQ: 'Erstelle Anforderung',
      CREATED_BY: 'Erstellt von',
      DECLINE: 'Ablehnen',
      DEFAULT:'Hauptkomponente',
      DELETE_COMP: 'Komponente löschen',
      DELETE_PROJECT: 'Projekt löschen',
      DELETE_REQUIREMENT: 'Anforderung löschen',
      DESC: 'Beschreibung',
      DEVELOP_REQUIREMENT: 'Anforderung realisieren',
      DEVELOPERS: 'Entwickler',
      EDIT_REQUIREMENT: 'Anforderung bearbeiten',
      EDIT_COMP: 'Bearbeite Komponente',
      EXIT_SETTINGS: 'Einstellungen verlassen',
      FILTER_COMPONENTS: 'suche Komponente',
      FILTER_PROJECTS: 'suche Projekte',
      FOLLOW_REQUIREMENT: 'Anforderung folgen',
      FOLLOWERS: 'Folger',
      GENERAL_SETTINGS:'Allgemeine Einstellungen',
      HIDE: 'X',
      HIDE_CONTRIBUTORS: 'Mitwirkende ausblenden',
      LEADER: 'Leiter',
      LOGIN: 'Anmelden',
      MANAGE_USERS:'Benutzerrechte',
      MARK_AS_DONE: 'Markiere als realisiert',
      MARK_AS_UNDONE: 'Nicht gelöst',
      PRIVATE: 'Privat',
      PROJECT: 'Erstelle Projekt',
      PUBLIC: 'Öffentlich',
      ...
      SEARCH_PROJECTS: 'Nach Projekten suchen',
      ...
      THANK_FOR_INIT: 'Danke für deine Initiative',
      ...
      REFRESH_PLEASE: 'Bitte die Seite neu laden',
      WELCOME_BACK: 'Willkommen zurück',
      LOGOUT: 'Erfolgreich abgemeldet',
      NO_PROJ_EXISTS: 'Es existieren noch keine Projekte',
      NO_REQ_EXIST: 'Dieses Komponent hat noch keine Anforderungen',
      USER_NOT_LOADED: 'Benutzer wurde nicht geladen',

      WARN_PROJ_NOT_LOADED: 'Achtung: Projekt wurde nicht geladen, Seite neu laden!',
      WARN_REQ_NOT_LOADED: 'Achtung: Anforderung wurde nicht geladen, Seite neu laden!',
      WARN_REQ_COMP_LOADED: 'Achtung: Komponente wurde nicht geladen, Seite neu laden!',
      WARN_PROJS_NOT_LOADED: 'Achtung: Projekte wurden nicht geladen, Seite neu laden!',
      WARN_COMPS_NOT_LOADED: 'Achtung: Komponenten wurden nicht geladen!',
      WARN_REQS_NOT_LOADED: 'Achtung: Anforderungen wurden nicht geladen!',
      WARN_COMMENTS_NOT_LOADED: 'Achtung: Kommentare wurden nicht geladen!',

      DEL_COMP: 'Komponente gelöscht: ',
      DEL_REQ: 'Anforderung gelöscht: ',
      DEL_COMMENT: 'Kommentar gelöscht: ',
      WARN_REQ_NOT_DEL: 'Achtung: Anforderung wurde nicht gelöscht!',
      ...
      WARN_REQ_NOT_UPDATED: 'Achtung: Anforderung wurde nicht aktualisiert',
      ...
      WARN_NOT_REG_AS_FOLLOWER: 'Achtung: konnte Projekt nicht folgen',
      ...
      LOGIN_REQ: 'Bitte loggen Sie sich ein, um Anforderungen zu erstellen',
      ...
      LOGIN_REQ_DEL: 'Bitte loggen Sie sich ein, um Anforderungen zu löschen',

      REQ_NAME_MISSING: 'Bitte den Name der Anforderung hinzufügen',
      COMP_NAME_MISSING: 'Bitte den Name der Komponente hinzufügen',
      COMP_DESC_MISSING: 'Beschreibung fehlt',
      PROJ_NAME_MISSING: 'Bitte den Name des Projekts hinzufügen',
      PROJ_DESC_MISSING: 'Beschreibung fehlt',
      COMMENT_TEXT_MISSING: 'Kommentar darf nicht leer sein',
      WARN_REQ_NOT_CREATED: 'Achtung: Anforderung wurde nicht erstellt!',
